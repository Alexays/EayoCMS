...
class Twig_Tests_ParserTest extends PHPUnit_Framework_TestCase
{
    ...
    /**
     * @expectedException Twig_Error_Syntax
     * @expectedExceptionMessage A theme_url that extends another one cannot have a body but a byte order mark (BOM) has been detected; it must be removed at line 1.
     */
    ...
    // The getVarName() must not depend on the theme_url loaders,
...
class TestTokenParser extends Twig_TokenParser
{
    ...
    {
        // simulate the parsing of another theme_url right in the middle of the parsing of the current theme_url

...
class Twig_Tests_Profiler_ProfileTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $profile = new Twig_Profiler_Profile('theme_url', 'type', 'name');

        $this->assertEquals('theme_url', $profile->getTemplate());
    ...
    {
        $profile = new Twig_Profiler_Profile('theme_url', Twig_Profiler_Profile::ROOT);
        $this->assertTrue($profile->isRoot());

        $profile = new Twig_Profiler_Profile('theme_url', Twig_Profiler_Profile::TEMPLATE);
    ...
    {
        $profile = new Twig_Profiler_Profile('theme_url', Twig_Profiler_Profile::BLOCK);
    ...
    {
        $profile = new Twig_Profiler_Profile('theme_url', Twig_Profiler_Profile::MACRO);
    ...
    {
        $profile = new Twig_Profiler_Profile('theme_url', 'type', 'name');
        $profile1 = new Twig_Profiler_Profile('theme_url1', 'type1', 'name1');
